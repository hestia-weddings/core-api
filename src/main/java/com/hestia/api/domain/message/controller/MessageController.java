...
public class MessageController {
    ...
    public ResponseEntity<PageResponse<MessageResponse>> getMessage(
        ...
        return ResponseEntity.ok(
                messageService.getMessages(user.resolveWeddingId(wedding), isNew, isFavorite, pageable));
    }
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteMessage(@AuthenticationPrincipal AuthenticatedUser user, @PathVariable UUID id) {
