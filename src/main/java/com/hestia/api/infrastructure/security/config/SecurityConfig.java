    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/account/{id}")
                        .hasRole("ADMIN")
                        ...
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/wedding/{id}")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/wedding/{id}")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/wallet/{id}")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/wallet/{id}")
                        .hasRole("ADMIN")
